...
## Generated on : Mon Apr 25 21:20:39 2022
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/V2X_RX_Baseband.exe
...
DEFINES_STANDARD = -DMODEL=V2X_RX_Baseband -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/V2X_RX_Baseband_ert_rtw/V2X_RX_Baseband.c $(START_DIR)/V2X_RX_Baseband_ert_rtw/V2X_RX_Baseband_data.c

MAIN_SRC = $(START_DIR)/V2X_RX_Baseband_ert_rtw/ert_main.c
...
OBJS = V2X_RX_Baseband.obj V2X_RX_Baseband_data.obj
...
%.obj : $(START_DIR)/V2X_RX_Baseband_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
...
V2X_RX_Baseband.obj : $(START_DIR)/V2X_RX_Baseband_ert_rtw/V2X_RX_Baseband.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


V2X_RX_Baseband_data.obj : $(START_DIR)/V2X_RX_Baseband_ert_rtw/V2X_RX_Baseband_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


ert_main.obj : $(START_DIR)/V2X_RX_Baseband_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
