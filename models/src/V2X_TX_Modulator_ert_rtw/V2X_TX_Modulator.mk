...
## Generated on : Sun Mar 06 18:32:08 2022
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/V2X_TX_Modulator.exe
...
DEFINES_STANDARD = -DMODEL=V2X_TX_Modulator -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/V2X_TX_Modulator_ert_rtw/V2X_TX_Modulator.c $(START_DIR)/V2X_TX_Modulator_ert_rtw/V2X_TX_Modulator_data.c

MAIN_SRC = $(START_DIR)/V2X_TX_Modulator_ert_rtw/ert_main.c
...
OBJS = V2X_TX_Modulator.obj V2X_TX_Modulator_data.obj
...
%.obj : $(START_DIR)/V2X_TX_Modulator_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
...
V2X_TX_Modulator.obj : $(START_DIR)/V2X_TX_Modulator_ert_rtw/V2X_TX_Modulator.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


V2X_TX_Modulator_data.obj : $(START_DIR)/V2X_TX_Modulator_ert_rtw/V2X_TX_Modulator_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


ert_main.obj : $(START_DIR)/V2X_TX_Modulator_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
